...
- The directory [model_prior_mean](https://github.com/gagneurlab/funcRVP/tree/orga-configs/scripts/model_prior_mean) contains scripts to run a variant of the FuncRVP model that models the mean of the prior instead of the variance.
